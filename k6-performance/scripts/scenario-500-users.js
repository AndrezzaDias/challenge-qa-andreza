// =============================================================
// scenario-500-users.js — 500 Usuários Simultâneos
// Base: https://quickpizza.grafana.com
//
// Execução:
//   k6 run scripts/scenario-500-users.js
// Com dashboard: k6 run --out web-dashboard scripts/scenario-500-users.js
// =============================================================
...
export function handleSummary(data) {
  return {
    'reports/report-500-users.html': htmlReport(data, { title: 'Cenário 500 Usuários — quickpizza.grafana.com' }),
